...
$v_{\rm min}=\min(v_i,v_{i+1})$ at the contact event $t_c$
...
$\tau_r$ in the past, with elastic hard-core collisions as
...
\caption{Resonance test: $R_2$ versus $\tau_r/\tau_{\rm sound}$
  ...
  (e.g., a deep trough at $\tau_r/\tau_{\rm sound}\approx 0.52$
  between elevated values at $0.48$ and $0.64$), inconsistent
