...
realised}: the $O(10^2)$ elastic collisions occurring during
the delay interval decorrelate the delayed information,
and the integrable hard-rod substrate shields the system
against shock formation. The tension between the continuum
prediction and the microscopic null result identifies
integrability as the obstacle to delay-induced shock onset.
\end{abstract}
